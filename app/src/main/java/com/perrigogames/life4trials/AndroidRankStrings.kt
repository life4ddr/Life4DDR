...
//
//    /**
//     * Complete X different Y's in a row.
//     * Complete a set of X, Y, and Z.
//     */
...
//
//    override fun difficultyString(difficultyNumbers: IntArray, plural: Boolean): String =
//        difficultyNumbers.map { d -> pluralNumber(d, plural) }.toListString(c)
//
//    override fun scoreString(score: Int, count: Int, difficulty: Int): String = when {
//        score == TrialData.MAX_SCORE -> throw IllegalArgumentException("Use 'marvelous' clear type instead of specifying 1000000")
//        score == TrialData.AAA_SCORE -> clearString(c.getString(R.string.clear_aaa))
//        count == 1 -> scoreSingleDifficulty(score, difficulty)
//        else -> c.getString(R.string.rank_goal_difficulty_score, score.longNumberString(), count, difficultyString(difficulty, true))
//    }
//
...
//
//    override fun clearSingleDifficulty(clearType: ClearType, difficulty: Int): String =
//        singleDifficultyAOrAn(c.getString(clearType.clearResShort), difficulty)
//
//    override fun scoreSingleDifficulty(score: Int, difficulty: Int): String =
//        singleDifficultyAOrAn(score.longNumberString(), difficulty)
//
//    override fun singleDifficultyAOrAn(leftText: String, difficulty: Int): String = when(difficulty) {
//        8, 11, 18 -> c.getString(R.string.rank_goal_difficulty_clear_single_an, leftText, difficultyString(difficulty, false))
//        else -> c.getString(R.string.rank_goal_difficulty_clear_single_a, leftText, difficultyString(difficulty, false))
//    }
//
