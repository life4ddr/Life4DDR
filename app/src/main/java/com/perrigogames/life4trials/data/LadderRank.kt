...
enum class LadderRank(val stableId: Long,
    ...
    @SerializedName("platinum1") PLATINUM1(55, R.drawable.platinum_1, R.string.platinum_1, PLATINUM),
    @SerializedName("platinum2") PLATINUM2(56, R.drawable.platinum_2, R.string.platinum_2, PLATINUM),
    @SerializedName("platinum3") PLATINUM3(57, R.drawable.platinum_3, R.string.platinum_3, PLATINUM),
...
enum class LadderRankGroup(@StringRes val nameRes: Int,
    ...
    PLATINUM(R.string.platinum, R.color.platinum),
