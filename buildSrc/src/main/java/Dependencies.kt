...
object Versions {
    ...
    val android_x_lifecycle = "2.1.0"
    val android_x_activity = "1.2.0-alpha05"
    val android_x_fragment = "1.3.0-alpha05"
...
object Deps {
    ...
    val activity = "androidx.activity:activity-ktx:${Versions.android_x_activity}"
    val fragment = "androidx.fragment:fragment-ktx:${Versions.android_x_fragment}"
    val fragment_testing = "androidx.fragment:fragment-testing:${Versions.android_x_fragment}"
