...
val DifficultyClass.nameRes get() =
    when (this) {
...
val DifficultyClass.abbreviationRes get() =
    when (this) {
        DifficultyClass.BEGINNER -> MR.strings.bgsp
        DifficultyClass.BASIC -> MR.strings.bsp
        DifficultyClass.DIFFICULT -> MR.strings.dsp
...
val LadderRank.categoryNameRes get() =
    when (this) {
        LadderRank.COPPER1,
        LadderRank.BRONZE1,
        LadderRank.SILVER1,
...
val LadderRankClass.nameRes get() =
    when (this) {
...
val ClearType.clearResShort get() =
    when (this) {
...
fun RankGoalUserType.titleString(): StringDesc =
    when (this) {
...
val LadderRankClass.colorRes get() =
    when (this) {
...
val DifficultyClass.colorRes get() =
    when (this) {
